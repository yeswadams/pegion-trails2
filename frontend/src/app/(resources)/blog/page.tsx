...
function AISection({ posts }: { posts: any[] }) {
  if (!posts || posts.length === 0)
    return (
      <div className="bg-[var(--color-primary)] max-w-full h-auto text-white text-lg flex flex-col items-center py-32 px-4 md:px-12">
        {" "}
  ...
  return (
    <section className="bg-[var(--color-primary)] ma-w-full h-auto text-white text-lg flex flex-col items-center py-32 px-4 md:px-12">
