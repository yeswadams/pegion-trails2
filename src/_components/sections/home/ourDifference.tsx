...
const differences = [
  ...
  },
  {
    ...
    description: "Whether you need more bandwidth or different skills, PegionTrails has whatever resources you need to get the job done.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: "Our amaizing team of creatives delivers excellent work in a fraction of the time.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
